...
"Resource/UI/MatchMakingDashboard.res"
{
	"MMDashboard"
	{
		...
		"resize_time"		"0.2"
				...
				"barv1"						{			ControlName				ImagePanel			FieldName				
			"barv1"
		"xpos"			"0+p0.001"
		"ypos"			"0+p0.001"
		"zpos"				2
		"wide"			"30"
		"tall"			"13"
			fillColor				"124 162 201 255"
	}		
				"barv2"						{			ControlName				ImagePanel			FieldName				
			"barv2"
		"xpos"			"0"
		"ypos"			"0"
		"zpos"				2
		...
		"pin_to_sibling"	"barv1"
					"pin_corner_to_sibling"					"PIN_TOPLEFT"
		"pin_to_sibling_corner"					"PIN_TOPRIGHT"		
	}	
				"bar1"						{			ControlName				ImagePanel			FieldName				
			"bar1"
		"xpos"			"rs1-p0.001"
		"ypos"			"0+p0.001"
		"zpos"				2
		"wide"			"30"
		"tall"			"13"
			fillColor				"152 186 188 255"
	}		
				"bar2"						{			ControlName				ImagePanel			FieldName				
			"bar2"
		"xpos"			"0"
		"ypos"			"0"
		"zpos"				2
		"wide"			"30"
		"tall"			"13"
			fillColor				"184 145 175 255"
	"pin_to_sibling"	"bar1"
					"pin_corner_to_sibling"					"PIN_TOPRIGHT"
		"pin_to_sibling_corner"					"PIN_TOPLEFT"			
	}	
				"bar3"						{			ControlName				ImagePanel			FieldName				
			"bar3"
		"xpos"			"0"
		"ypos"			"0"
		"zpos"				2
		"wide"			"30"
		"tall"			"13"
			fillColor				"124 164 189 255"
	"pin_to_sibling"	"bar2"
					"pin_corner_to_sibling"					"PIN_TOPRIGHT"
		"pin_to_sibling_corner"					"PIN_TOPLEFT"			
	}	
				"bar4"						{			ControlName				ImagePanel			FieldName				
			"bar4"
		"xpos"			"0"
		"ypos"			"0"
		"zpos"				2
		"wide"			"30"
		"tall"			"13"
			fillColor				"239 206 129 255"
	"pin_to_sibling"	"bar3"
					"pin_corner_to_sibling"					"PIN_TOPRIGHT"
		"pin_to_sibling_corner"					"PIN_TOPLEFT"			
	}	
				"bar5"						{			ControlName				ImagePanel			FieldName				
			"bar5"
		"xpos"			"0"
		"ypos"			"0"
		"zpos"				2
